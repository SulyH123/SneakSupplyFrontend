        ...
        <div className='testimonails mt-5'>
          <div className="testimonial">
            <div className="testimonial-content">         
             ...
             Sneak and Supply made finding the perfect sneakers a breeze! With their extensive selection and easy-to-use platform, I found my dream kicks in minutes. Plus, their fast shipping is unbeatable!
=            </div>
          ...
          <div className="testimonial testimonial-2">
            <div className="testimonial-content">         
             <i class="fa-solid fa-quote-left fa-2xl"></i> <br />
             I'm impressed by the personalized recommendations and seamless checkout process at Sneak and Supply. The whole experience was smooth, and my sneakers arrived quickly and fit perfectly!
=            </div>
            <div className="testimonial-userdetails">
              <h5>Mark T.</h5>
              <p>Ceo Of Amazon</p>
